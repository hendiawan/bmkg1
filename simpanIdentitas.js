...
//        var idpos = $("#idpos1").val();
        var idpos_msg = document.getElementById('idpos_msg');
...
//        var idposS;
        ...
        if (pelaksana == '') {
            ...
            pelaksana_msg.innerHTML = "Pelaksana Tidak Boleh Kosong!";
            pelaksanaS = 0;
        }
        if (tanggal == '') {
        ...
        if (kalibrasiTerakhir == '') {
            ...
            kalibrasiTerakhir_msg.innerHTML = "Kalibrasi Tidak Boleh Kosong!";
...
//        if (idpos == '') {
//            idpos_msg.style.color = badColor;
//            idpos_msg.innerHTML = "ID POS Tidak Boleh Kosong!";
//            idposS = 0;
//        }
        if (idaws == '') {
        ...
        if (
            ...
            $.ajax({
                ...
                data: " x=" + x + "&y=" + y + "&e=" + e + "&idaws=" + idaws + "&jenis_komunikasi=" + jenis_komunikasi + "&nomorgsm=" + nomorgsm +
                        ...
                        "&tanggal=" + tanggal + "&pelaksana=" + pelaksana + "&id=" + id + "&lokasi=" + lokasi + "&alamat=" + alamat,
                cache: false,
